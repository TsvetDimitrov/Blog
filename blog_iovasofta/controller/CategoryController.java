...
import blog_iovasofta.bindingModel.CategoryBindingModel;
...
public class CategoryController {
    ...
    public String list(Model model){
        model.addAttribute("view", "admin/category/list"); // Tuka ne razbiram kvo se sluchva otidi na 89 stranica.
