...
import blog_iovasofta.bindingModel.UserBindingModel;
import blog_iovasofta.bindingModel.UserEditBindingModel;
import blog_iovasofta.entity.Article;
import blog_iovasofta.entity.Role;
import blog_iovasofta.entity.User;
import blog_iovasofta.repository.ArticleRepository;
import blog_iovasofta.repository.RoleRepository;
...
public class AdminUserController {
    ...
    public String edit(@PathVariable Integer id, Model model){
        if(!this.userRepository.existsById(id)){ // tuk trqbva da exists
            return "redirect:/admin/users/";
        }

        User user = this.userRepository.getOne(id); // tuk trqbva da e findOne(id)
